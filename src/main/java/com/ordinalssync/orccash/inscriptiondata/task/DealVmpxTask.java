...
@Component
@EnableScheduling
public class DealVmpxTask {

    private static final String SYNC_LOCK_KEY = "ordinalsSync-cash:dealVmpx";
    ...
    public DealVmpxTask(InscriptionDealDataTask inscriptionDealDataTask
    ) {
