...
@Component
@EnableScheduling
public class DealSatsTask {

    private static final String SYNC_LOCK_KEY = "ordinalsSync-cash:dealSats";
    ...
    public DealSatsTask(InscriptionDealDataTask inscriptionDealDataTask
    ) {
